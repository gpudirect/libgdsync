...
int gds_map_mem(void *_ptr, size_t size, gds_poll_memory_type_t mem_type, CUdeviceptr *dev_ptr);
...
int gds_register_mem(void *_ptr, size_t size, gds_poll_memory_type_t type, CUdeviceptr *dev_ptr);
